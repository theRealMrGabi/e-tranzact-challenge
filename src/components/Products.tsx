...
export const Products: FC = () => {
	...
	return (
		<div className="homeCont pt-4 w-full">
			...
			<div>
				{/* I am making an assumption that total items amounts to 60, this is because when i fetch products by page, i only get amount of products for that particular page */}
				<Pagination
					onPageChange={(page) => {
						setCurrPage(page);
